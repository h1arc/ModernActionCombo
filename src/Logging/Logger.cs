...
public static class Logger
{
    ...
    {
        if (_logger != null) _logger.Information(string.Format(format, args));
    }
    public static void Debug(string format, params object[] args)
    {
        if (_isDebugEnabled && _logger != null) _logger.Debug(string.Format(format, args));
    }
    public static void Warning(string format, params object[] args)
    {
        if (_logger != null) _logger.Warning(string.Format(format, args));
    }
    public static void Error(string format, params object[] args)
    {
        if (_logger != null) _logger.Error(string.Format(format, args));
    }
